# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-02-06 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('courseorg', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgnization.CourseOrg', verbose_name='\u6240\u5728\u673a\u6784')),
            ],
            options={
                'verbose_name': '\u6559\u5e08',
