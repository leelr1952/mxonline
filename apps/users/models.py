...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(choices=(('male',u'男'),('female',u'女')),default='female',verbose_name=u'性别',max_length=6)
    address = models.CharField(max_length=100,verbose_name=u'地址',default=u'')
    mobilephone = models.CharField(max_length=11,verbose_name=u'联系方式',null=True,blank=True)
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(("register",u"注册"),("forget",u"找回密码"),("update",u"修改邮箱")),max_length=10, verbose_name=u'发送类型')
