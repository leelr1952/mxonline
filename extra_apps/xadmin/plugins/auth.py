...
# django中的bug：此处必须用get_user_model返回settings中定义的AUTH_USER_MODEL
# 否则User就是django中自己的User，不是我们定义的UserProfile，之后就可以
# 在Users的adminx中注释掉unregister(User)及register(UserProfile, UserProfileAdmin)
...
class UserAdmin(object):
    ...
    model_icon_useradmin = 'fa fa-user'
